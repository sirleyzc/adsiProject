                    ...
                    <div class="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md">
                        ...
                        <form method="#" action="#" class="mt-10">
                            ...
                            <div class="mt-7 mb-5">
                                ...
                                hover:scale-105"  v-if="button == false" @click="regPay">
                                    Guardar
                                </button>
                                <button class="bg-gradient-to-r from-cyan-500 to-emerald-500 w-full py-3 rounded-xl text-white 
                                shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x 
                                hover:scale-105" v-else @click="updPay">
                                    Actualizar
                                </button>
                            </div>    
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="flex flex-col ml-3">
                            <div class="font-medium leading-none text-white">¿Deseas eliminar el pago del empleado {{nameEmp}}?</div>
                            <p class="text-sm text-white leading-none mt-1">Recuerda que este proceso no es reversible
                            </p>
                        </div>
                    </div>
                    <button @click="destroyPay" class="flex-no-shrink bg-emerald-900 px-5 ml-4 py-2 text-sm shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-emerald-900 text-white rounded-full">Si</button>
