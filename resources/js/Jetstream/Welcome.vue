<template>
    <div>
        ...
        <!-- component -->
        <div class="py-4 bg-emerald-500 text-white">
            <div class="container mx-auto flex flex-col md:flex-row my-8 md:my-36">
                <div class="flex flex-col w-full lg:w-2/5 p-48">
                    <p class="text-3xl md:text-5xl text-gray-700 my-4 relaxed md:leading-snug">¡Bienvenido!</p>
                </div>
